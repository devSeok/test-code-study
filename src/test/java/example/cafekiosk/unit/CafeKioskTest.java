...
class CafeKioskTest {
    ...
    void addZeroBeverages() {
        ...
        assertThatThrownBy(() -> cafeKiosk.add(americano, 0))
                ...
                .hasMessage("음료는 한잔 이상 주문이 가능합니다");
    }
    ...
    void createOrderWithCurrentTime() {
        ...
        Order order = cafeKiosk.createOrder(LocalDateTime.of(2023, 6,2, 14,0));
    ...
    void createOrderOutsideCurrentTime() {
        ...
        assertThatThrownBy(() -> cafeKiosk.createOrder(LocalDateTime.of(2023, 6,2, 03,0)))
                .isInstanceOf(IllegalArgumentException.class)
